...
export function getCodeList() {
    ...
    Object.keys(personalityTypes).sort().forEach((pt) => {
        codes.push({
...
- Make every attempt possible to provide simplistic answers that are quick and concise.
...
Use one of the following "Tags" at the beginning of each response based on how your Persona would respond using their Personality Traits, Biography, Likes & Dislikes.
