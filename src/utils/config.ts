...
const defaults = {
  ...
  coquiLocal_url: process.env.NEXT_PUBLIC_COQUILOCAL_URL ?? `http://${local_ip_address}:5002`,
  ...
  localXTTS_url: process.env.NEXT_PUBLIC_LOCALXTTS_URL ?? `http://${local_ip_address}:7851`,
  ...
  rvc_url: process.env.NEXT_PUBLIC_RVC_URL ?? `http://${local_ip_address}:8001/voice2voice`,
  ...
  vision_llamacpp_url: process.env.NEXT_PUBLIC_VISION_LLAMACPP_URL ?? `http://${local_ip_address}:8081`,
  vision_ollama_model: process.env.NEXT_PUBLIC_VISION_OLLAMA_MODEL ?? 'llava',
  vision_ollama_url: process.env.NEXT_PUBLIC_VISION_OLLAMA_URL ?? `http://${local_ip_address}:11434`,
  vision_system_prompt: process.env.NEXT_PUBLIC_VISION_SYSTEM_PROMPT ?? `You are a friendly human named Peter. Describe the image in detail. Let's start the conversation.`,
  ...
  wake_word: 'Hello',
  whispercpp_url: process.env.NEXT_PUBLIC_WHISPERCPP_URL ?? `http://${local_ip_address}:8080`,
  youtube_videoid: '',
};
