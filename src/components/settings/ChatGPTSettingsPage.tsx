...
export function ChatGPTSettingsPage({
  ...
  const description = (
    <>
      ...
      <a href="https://platform.openai.com">platform.openai.com</a>. You can generally use
      other OpenAI compatible URLs and models here too, such as{' '}
  ...
  return (
    <BasicPage title="ChatGPT Settings" description={description}>
      {config('chatbot_backend') !== 'chatgpt' && (
        <NotUsingAlert>
          You are not currently using ChatGPT as your ChatBot backend. These settings will
          not be used.
        </NotUsingAlert>
      )}
