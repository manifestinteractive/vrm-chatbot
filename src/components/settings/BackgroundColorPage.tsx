        ...
        <li className="py-4">
          {bgColor === '' && (
            <p className="text-xs text-gray-500">
              {t('no_bg_color', 'No background color set. Click the box below.')}
            </p>
          )}
          <FormRow label={t('Color')}>
            <div className="flex items-center">
              <input
                className={
                  'block bg-white border-0 outline-none focus:ring-0 focus:border-gray-300 rounded-md shadow-sm w-20'
                }
                type="color"
                value={bgColor}
