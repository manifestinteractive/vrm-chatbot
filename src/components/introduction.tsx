  ...
  return (
    <div className="absolute z-40 h-full w-full bg-black/30 mx-auto sm:px-24 lg:px-32 font-M_PLUS_2">
      <div className="mx-auto max-h-full overflow-auto rounded-lg bg-white/40 p-4 backdrop-blur-lg shadow-lg">
        <div className="my-4">
          <div className="my-8 font-bold text-xl">{t('Welcome to Amica')}</div>
          <p>
            {t(
              'amica_intro',
              `
        ...
        <div className="my-4">
          <div className="my-8 font-bold typography-20">{t('Setup')}</div>
          <p>
            {t(
              'amica_setup',
              `
          ...
          `,
            ...
            <a href="https://docs.heyamica.com" target="_blank" className="text-cyan-500">
