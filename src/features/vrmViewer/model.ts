...
export class Model {
  ...
  private async resetExpression() {
    console.log('expressions', 'resetExpression');
    clearTimeout(this._timeout);
    this._timeout = setTimeout(() => {
      this.emoteController?.playEmotion('neutral');
      console.log('expressions', 'resetExpression', 'triggered');
    }, 5000);
  }
  ...
  public async playEmotion(expression: string) {
    ...
    console.log('expressions', 'playEmotion', expression);
  }
  ...
  public async speak(buffer: ArrayBuffer, screenplay: Screenplay) {
    ...
    console.log('expressions', 'speak', screenplay.expression);
    this.resetExpression();
